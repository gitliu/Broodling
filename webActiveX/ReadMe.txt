========================================================================
		ActiveX Control DLL : WEBACTIVEX
========================================================================

ControlWizard has created this project for your WEBACTIVEX ActiveX Control
...
that make up your WEBACTIVEX ActiveX Control DLL.
...
WebActiveXCtl.h
	This file contains the declaration of the CWebActiveXCtrl C++ class.

WebActiveXCtl.cpp
	This file contains the implementation of the CWebActiveXCtrl C++ class.

WebActiveXPpg.h
	This file contains the declaration of the CWebActiveXPropPage C++ class.

WebActiveXPpg.cpp
	This file contains the implementation of the CWebActiveXPropPage C++ class.

WebActiveXCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CWebActiveXCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file webActiveX.rc.
